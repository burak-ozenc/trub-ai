          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 bg-white text-black border border-gray-300 rounded-md shadow-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500"
              />
            </div>
            <div>
